        ...
        if($(window).scrollTop() < $(".byline-section").offset().top + $(window).height() / 2) {
            if($(".stickynav").length > 0) {
                ...
                if ($(".stickynav").length < 1) {
                    $("body").append('<div class="stickynav" id="invnav-rail"><div class="stickyheader">Undercover<br>Gangster</div><div class="menu"><div class="part"><a href="http://www.philly.com/philly/news/crime/philly-undercover-gangster-part-1.html"><div class="name">In Their Fathers’ Footsteps</div><div class="pubdate">Nov. 13</div></a></div><div class="part notready"><a href="http://www.philly.com/philly/news/crime/philly-undercover-gangster-part-2.html"><div class="name">Portrait of a Suspect</div><div class="pubdate">Nov. 14</div></a></div><div class="part notready"><a href="http://www.philly.com/philly/news/crime/philly-undercover-gangster-part-3.html"><div class="name">Another Twist, Another Crime</div><div class="pubdate">Nov. 15</div></a></div><div class="part notready"><a href="http://www.philly.com/philly/news/crime/philly-undercover-gangster-part-4.html"><div class="name">Interrogation</div><div class="pubdate">Nov. 16</div></a></div><div class="part notready"><a href="http://www.philly.com/philly/news/crime/philly-undercover-gangster-part-5.html"><div class="name">The Reckoning</div><div class="pubdate">Nov. 17</div></a></div></div></div>')
                }
                $(".stickynav").hover(
                    function() {
